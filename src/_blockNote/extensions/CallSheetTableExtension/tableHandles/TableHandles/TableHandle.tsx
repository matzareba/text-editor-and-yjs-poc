...
import { getCallSheetTableHandlesExtension } from "../CallSheetTableHandlesPlugin.js";
import { callSheetTableBlockType } from "../../consts.js";
...
>(
  ...
  const isDraggable = useMemo(() => {
    const tableHandles = getCallSheetTableHandlesExtension(props.editor);
    if (
      !tableHandles ||
      !props.block ||
      props.block.type !== callSheetTableBlockType
    ) {
      return false;
    }
  ...
  }, [props.block, props.index, props.orientation]);
